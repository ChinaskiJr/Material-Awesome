  ...
  panel:setup {
    ...
    nil,
    {
      layout = wibox.layout.fixed.horizontal,
      {
        ...
        {
          layout = wibox.layout.fixed.horizontal,
          wibox.container.constraint(require('widget.cpu.cpu-meter'), 'max', s.geometry.width / 24),
          wibox.container.constraint(require('widget.ram.ram-meter'), 'max', s.geometry.width / 24),
          wibox.container.constraint(require('widget.temperature.temperature-meter'), 'max', s.geometry.width / 24),
          wibox.container.constraint(require('widget.harddrive.harddrive-meter'), 'max', s.geometry.width / 24),
